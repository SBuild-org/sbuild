...
class SBuildRunner {
   ...
   * If the file already exists, it will throw an [[org.sbuild.SBuildException]].
   *
   */
  ...
  def run(args: Array[String]): Int = {
    ...
    try {
      ...
      cp.setResourceBundle("org.sbuild.runner.Messages", getClass.getClassLoader())
