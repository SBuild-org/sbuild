...
class SBuild(implicit _project: Project) {
  ...
  val addonsJar = s"target/org.sbuild.addons-${SBuildConfig.sbuildVersion}.jar"
  val addonsSourcesJar = s"target/org.sbuild.addons-${SBuildConfig.sbuildVersion}-sources.jar"
